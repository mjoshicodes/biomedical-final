...
IDENTIIED_GENES_ANNOVAR = {"UMODL1", "KRTAP12-2", "KRTAP10-10", "PCNT", "KRTAP10-7", "LCA5L", "COL18A1", "IFNAR2", "KRTAP10-1", "KRTAP10-3"}
...
def check_if_in_genes(record):
    ...
    for gene in genes:
        if gene.gene_name in IDENTIIED_GENES_ANNOVAR:
...
# Usage example
create_gene_vcf('template.vcf', 'extra_credit_gene_variants_chr21.vcf')
